...
er1=zeros(1,c);
for i=1:1:10
    [ve1(i),er1(i)]=test1t(i);
end
for i=11:28
    [ve1(i),er1(i)]=test1t(10+(i-10)*5);
end
%figure,plot(x,ve1,'g--'),hold on;
%plot(x,er1,'y*'),hold on;
%title('Logistic Regression  and testing(Log)');
%legend('Log-validation','Log-testing');
ve2=zeros(1,c);
er2=zeros(1,c);
for i=1:1:10
    [ve2(i),er2(i)]=test3t(i);
end
for i=11:28
    [ve2(i),er2(i)]=test3t(10+(i-10)*5);
end
ve3=zeros(1,c);
er3=zeros(1,c);
for i=1:1:10
    [ve3(i),er3(i)]=test4t(i);
end
for i=11:28
    [ve3(i),er3(i)]=test4t(10+(i-10)*5);
end
...
plot(x,er3,'b'),hold on;
plot(x,er1,'y'),hold on;
title('Logistic Regression of Three Methods of training and testing');
%legend('Log-validation','Beta-validation','B-validation','Log-test','Z-test','B-test');
legend('Beta-training','Z-training','Log-training','Beta-test','Z-test','Log-test');
axis([0 100 0 1]);
er1(1)
er1(10)
er1(28)
